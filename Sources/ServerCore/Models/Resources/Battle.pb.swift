...
struct Battle: SwiftProtobuf.Message {
  static let protoMessageName: String = "Battle"

  var duration: UInt32 = 0

  var forces: [Battle.Force] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  struct Force: SwiftProtobuf.Message {
    static let protoMessageName: String = Battle.protoMessageName + ".Force"

    var name: String = String()

    var quantity: Int64 = 0

    var casualties: Int64 = 0
...
extension Battle: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Battle) -> Bool {
...
extension Battle.Force: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Battle.Force) -> Bool {
